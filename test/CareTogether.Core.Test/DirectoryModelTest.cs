...
namespace CareTogether.Core.Test
{
    ...
    public class DirectoryModelTest
    {
        ...
        public async Task TestInitializeAsyncWithEvenMoreEvents()
        {
            ...
            Assert.AreEqual(
                expectedFamily.CustodialRelationships.Count,
                actualFamily.CustodialRelationships.Count
            );
            Assert.AreEqual(
                expectedFamily.CustodialRelationships[0],
                actualFamily.CustodialRelationships[0]
            );
            Assert.AreEqual(
                expectedFamily.CustodialRelationships[1],
                actualFamily.CustodialRelationships[1]
            );
        }
