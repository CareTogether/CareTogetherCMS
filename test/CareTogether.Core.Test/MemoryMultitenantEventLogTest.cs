...
namespace CareTogether.Core.Test
{
    ...
    public class MemoryMultitenantEventLogTest
    {
        ...
        public async Task AppendingAnEventToAnUninitializedTenantLogStoresItWithTheCorrectSequenceNumber()
        {
            ...
            var appendResult = await dut.AppendEventAsync(guid1, guid2, 42, 0);
            ...
            Assert.AreEqual((42, 0), getResult[0]);
        }
        ...
        public async Task AppendingMultipleEventsToAnUninitializedTenantLogStoresThemCorrectly()
        {
            ...
            var appendResult1 = await dut.AppendEventAsync(guid1, guid2, 41, 0);
            var appendResult2 = await dut.AppendEventAsync(guid1, guid2, 42, 1);
            ...
            Assert.AreEqual((41, 0), getResult[0]);
            Assert.AreEqual((42, 1), getResult[1]);
            Assert.AreEqual((43, 2), getResult[2]);
        }
        ...
        public async Task AppendingMultipleEventsToAnInitializedTenantLogStoresThemCorrectly()
        {
            ...
            Assert.AreEqual((41, 0), getResult2[0]);
            Assert.AreEqual((42, 1), getResult2[1]);
            Assert.AreEqual((43, 2), getResult2[2]);
        }
        ...
        public async Task AppendingMultipleEventsToAnUninitializedTenantLogValidatesSequenceNumbers()
        {
            ...
            var appendResult3 = await dut.AppendEventAsync(guid1, guid2, 43, 1);
            var getResult = await dut.GetAllEventsAsync(guid1, guid2).ToListAsync();
            Assert.IsTrue(appendResult1.IsT0);
            ...
            Assert.AreEqual((41, 0), getResult[0]);
            Assert.AreEqual((43, 1), getResult[1]);
        }
        ...
        public async Task AppendingMultipleEventsToMultipleTenantLogsMaintainsSeparation()
        {
            ...
            {
                await dut.AppendEventAsync(guid1, guid2, 1, 0),
                await dut.AppendEventAsync(guid1, guid2, 2, 1),
                await dut.AppendEventAsync(guid1, guid2, 3, 2),
                await dut.AppendEventAsync(guid1, guid4, 1, 0),
                await dut.AppendEventAsync(guid1, guid4, 2, 1),
                await dut.AppendEventAsync(guid1, guid4, 3, 2),
                await dut.AppendEventAsync(guid2, guid3, 1, 0),
                await dut.AppendEventAsync(guid2, guid3, 2, 1),
                await dut.AppendEventAsync(guid2, guid3, 3, 2),
                await dut.AppendEventAsync(guid1, guid2, 4, 3)
            };
            var getResult = await dut.GetAllEventsAsync(guid1, guid2).ToListAsync();
            Assert.IsTrue(appendResults.All(result => result.IsT0));
            Assert.AreEqual(4, getResult.Count);
            Assert.AreEqual((1, 0), getResult[0]);
            Assert.AreEqual((2, 1), getResult[1]);
            Assert.AreEqual((3, 2), getResult[2]);
            Assert.AreEqual((4, 3), getResult[3]);
        }
    }
}
