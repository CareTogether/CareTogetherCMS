...
namespace CareTogether.Core.Test.ReferralCalculationTests
{
    ...
    public class AuthorizeFamilyAccess
    {
        ...
        [DataTestMethod]
        [DataRow('0', true, false, false, false, false, false)]
        [DataRow('1', true, true, true, true, true, false)]
        [DataRow('2', true, true, true, true, true, false)]
        [DataRow('3', true, true, true, true, true, false)]
        [DataRow('4', true, true, true, true, true, false)]
        [DataRow('5', true, true, true, true, true, false)]
        [DataRow('6', true, true, true, true, true, false)]
        [DataRow('7', true, true, true, true, true, false)]
        [DataRow('8', true, true, true, true, true, false)]
        [DataRow('9', true, true, true, true, true, false)]
        [DataRow('a', true, true, true, true, true, false)]
        [DataRow('b', false, false, false, false, false, true)]
        [DataRow('c', false, false, false, false, false, true)]
        [DataRow('d', false, false, false, false, false, false)]
        [DataRow('e', false, false, false, false, false, false)]
