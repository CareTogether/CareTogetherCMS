...
public class FindRequirementApprovalsTest
{
    ...
    {
        var result = SharedCalculations.FindRequirementApprovals("A", null, H.Completed([]), H.ExemptedOn([]));
    ...
    {
        var result = SharedCalculations.FindRequirementApprovals("A", H.DT(20), H.Completed([]), H.ExemptedOn([]));
    ...
    {
        var result = SharedCalculations.FindRequirementApprovals("A", null, H.Completed([("A", 2)]), H.ExemptedOn([]));

        Assert.IsNotNull(result);
        Assert.IsTrue(result.Ranges.SequenceEqual([new DateRange(H.D(2), DateOnly.MaxValue)]));
    }
    ...
    public void MatchingCompletedExpiringReturnsTimeline()
    {
        ...
        Assert.IsNotNull(result);
        Assert.IsTrue(result.Ranges.SequenceEqual([new DateRange(H.D(2), H.D(4))]));
    }
    ...
    public void MatchingCompletedExpiringNonoverlappingReturnsTimeline()
    {
        ...
        Assert.IsNotNull(result);
        Assert.IsTrue(result.Ranges.SequenceEqual([new DateRange(H.D(2), H.D(4)), new DateRange(H.D(6), H.D(9))]));
    }
    ...
    public void MatchingCompletedExpiringOverlappingReturnsSingleTimeline()
    {
        ...
        Assert.IsNotNull(result);
        Assert.IsTrue(result.Ranges.SequenceEqual([new DateRange(H.D(2), H.D(9))]));
    }
    ...
    public void MatchingExemptedNonexpiringReturnsTimeline()
    {
        ...
        Assert.IsNotNull(result);
        Assert.IsTrue(result.Ranges.SequenceEqual([new DateRange(H.D(3), DateOnly.MaxValue)]));
    }
    ...
    public void MatchingExemptedExpiringReturnsTimeline()
    {
        ...
        Assert.IsNotNull(result);
        Assert.IsTrue(result.Ranges.SequenceEqual([new DateRange(H.D(3), H.D(6))]));
    }
    ...
    public void MatchingExemptedExpiringMultipleReturnsSingleTimeline()
    {
        ...
        Assert.IsNotNull(result);
        Assert.IsTrue(result.Ranges.SequenceEqual([new DateRange(H.D(3), H.D(9))]));
    }
    ...
    public void MatchingCompletedAndExemptedExpiringOnlyAfterSupersededReturnsExemptions()
    {
        ...
        Assert.IsNotNull(result);
        Assert.IsTrue(result.Ranges.SequenceEqual([new DateRange(H.D(13), H.D(17))]));
    }
    ...
    public void MatchingWithSupersededReturnsOnlyNonsupersededRanges()
    {
        ...
        Assert.IsNotNull(result);
        Assert.IsTrue(result.Ranges.SequenceEqual([new DateRange(H.D(5), H.D(17))]));
    }
}
