        ...
        public static async Task PopulateReferralEvents(IEventLog<ReferralEvent> referralsEventLog)
        {
            await referralsEventLog.AppendEventsAsync(guid1, guid2,
                ...
                new ArrangementsCommandExecuted(adminId, new DateTime(2020, 3, 15, 8, 33, 34), new TrackChildLocationChange(guid1, guid1, ImmutableList.Create(guid1),
                    new DateTime(2020, 3, 15, 8, 33, 34), guid3, ChildLocationPlan.DaytimeChildCare, guid4)),
                new ArrangementsCommandExecuted(adminId, new DateTime(2020, 3, 15, 20, 40, 45), new TrackChildLocationChange(guid1, guid1, ImmutableList.Create(guid1),
                        new DateTime(2020, 3, 15, 20, 40, 45), guid2, ChildLocationPlan.DaytimeChildCare, guid5)),
                ...
                new ArrangementsCommandExecuted(adminId, new DateTime(2020, 3, 22, 16, 30, 35), new TrackChildLocationChange(guid1, guid1, ImmutableList.Create(guid1),
                    new DateTime(2020, 3, 22, 16, 30, 35), guid1, ChildLocationPlan.OvernightHousing, guid6)),
                new ArrangementsCommandExecuted(adminId, new DateTime(2020, 3, 24, 8, 30, 35), new TrackChildLocationChange(guid1, guid1, ImmutableList.Create(guid1),
                    new DateTime(2020, 3, 24, 8, 30, 35), guid2, ChildLocationPlan.OvernightHousing, guid7)),
                new ArrangementsCommandExecuted(adminId, new DateTime(2020, 3, 30, 18, 18, 18), new TrackChildLocationChange(guid1, guid1, ImmutableList.Create(guid1),
                    new DateTime(2020, 3, 30, 18, 18, 18), guid1, ChildLocationPlan.WithParent, guid8)),
