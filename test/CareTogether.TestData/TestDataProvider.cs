    ...
    public static class TestDataProvider
    {
        ...
        public static async Task PopulateReferralEvents(IEventLog<ReferralEvent> referralsEventLog)
        {
            await referralsEventLog.AppendEventsAsync(guid1, guid2,
                ...
                new ArrangementsCommandExecuted(adminId, new DateTime(2020, 3, 11, 11, 12, 13), new CreateArrangement(guid1, guid1, ImmutableList.Create(guid1), "Hosting", new DateTime(2020, 3, 11), guid3, null)),
                new ArrangementsCommandExecuted(adminId, new DateTime(2020, 3, 11, 11, 13, 10), new EditArrangementReason(guid1, guid1, ImmutableList.Create(guid1), "Crisis")),
                ...
                new ArrangementsCommandExecuted(adminId, new DateTime(2022, 3, 3, 10, 0, 0), new CreateArrangement(guid1, guid2, ImmutableList.Create(guid2), "Babysitting", new DateTime(2022, 3, 2), guid3, "Assistance")),
                new ArrangementsCommandExecuted(adminId, new DateTime(2022, 3, 3, 10, 0, 0), new CreateArrangement(guid1, guid2, ImmutableList.Create(guid3), "Friending", new DateTime(2022, 4, 2), guid1, "Respite")),
                new ArrangementsCommandExecuted(adminId, new DateTime(2022, 3, 3, 10, 0, 0), new CreateArrangement(guid1, guid2, ImmutableList.Create(guid4), "Friending", new DateTime(2022, 5, 2), guid2, "Respite")),
                new ArrangementsCommandExecuted(adminId, new DateTime(2022, 3, 3, 10, 0, 0), new CreateArrangement(guid1, guid2, ImmutableList.Create(guid5), "Hosting", new DateTime(2022, 3, 2), guid3, null)),
