    ...
    public static class TestDataProvider
    {
        ...
        public static async Task PopulateReferralEvents(IMultitenantEventLog<ReferralEvent> referralsEventLog)
        {
            await referralsEventLog.AppendEventsAsync(guid1, guid2,
                ...
                new ReferralCommandExecuted(adminId, new DateTime(2020, 3, 5, 4, 15, 15), new UploadReferralDocument(guid1, guid1, "Jane Doe referral info.pdf")),
                new ReferralCommandExecuted(adminId, new DateTime(2020, 3, 5, 4, 15, 15), new CompleteReferralRequirement(guid1, "Request for Help Form", new DateTime(2020, 3, 5, 4, 12, 15), guid1)),
                new ReferralCommandExecuted(adminId, new DateTime(2020, 3, 6, 8, 45, 30), new CompleteReferralRequirement(guid1, "Intake Coordinator Screening Call", new DateTime(2020, 3, 6, 8, 45, 30), adminId)),
                new ArrangementCommandExecuted(adminId, new DateTime(2020, 3, 11, 11, 12, 13), new CreateArrangement(guid1, guid1, "Hosting")),
                new ArrangementCommandExecuted(adminId, new DateTime(2020, 3, 11, 11, 13, 14), new AssignIndividualVolunteer(guid1, guid1, guid4, guid4, "Family Coach")),
                ...
                new ArrangementCommandExecuted(adminId, new DateTime(2020, 3, 12, 16, 55, 0), new StartArrangement(guid1, guid1, new DateTime(2020, 3, 12, 16, 55, 0))),
                new ArrangementCommandExecuted(adminId, new DateTime(2020, 3, 15, 8, 33, 34), new TrackChildLocationChange(guid1, guid1,
                    new DateTime(2020, 3, 15, 8, 33, 34), guid3, guid3, ChildLocationPlan.DaytimeChildCare, "Babysitting")),
                new ArrangementCommandExecuted(adminId, new DateTime(2020, 3, 15, 20, 40, 45), new TrackChildLocationChange(guid1, guid1,
                        new DateTime(2020, 3, 15, 20, 40, 45), guid3, guid2, ChildLocationPlan.DaytimeChildCare, "Dropped off with host parents after ☕ and 🍰")),
                new ArrangementCommandExecuted(adminId, new DateTime(2020, 3, 14, 10, 10, 10), new CompleteArrangementRequirement(guid1, guid1,
                    "Family Coach Safety Visit", new DateTime(2020, 3, 14, 10, 10, 10), guid4)),
                new ArrangementCommandExecuted(adminId, new DateTime(2020, 3, 21, 11, 11, 11), new CompleteArrangementRequirement(guid1, guid1,
                    "Family Coach Supervision", new DateTime(2020, 3, 21, 11, 11, 11), adminId)),
                new ArrangementCommandExecuted(adminId, new DateTime(2020, 3, 22, 16, 30, 35), new TrackChildLocationChange(guid1, guid1,
                ...
                new ArrangementCommandExecuted(adminId, new DateTime(2020, 3, 24, 8, 30, 35), new TrackChildLocationChange(guid1, guid1,
                ...
                new ArrangementCommandExecuted(adminId, new DateTime(2020, 3, 30, 18, 18, 18), new TrackChildLocationChange(guid1, guid1,
                ...
                new ReferralCommandExecuted(adminId, new DateTime(2021, 7, 10, 19, 32, 0), new UploadReferralDocument(guid2, guid2, "Jane Doe second referral info.pdf")),
                new ReferralCommandExecuted(adminId, new DateTime(2021, 7, 10, 19, 32, 0), new CompleteReferralRequirement(guid2, "Request for Help Form", new DateTime(2021, 7, 10, 18, 0, 0), guid2)),
                new ReferralCommandExecuted(adminId, new DateTime(2021, 7, 10, 19, 32, 0), new CompleteReferralRequirement(guid2, "Intake Coordinator Screening Call",
