    ...
    public static class TestDataProvider
    {
        ...
        public static async Task PopulateCommunityEvents(IMultitenantEventLog<CommunityEvent> communityEventLog)
        {
            await communityEventLog.AppendEventsAsync(guid1, guid2,
                ...
                new PersonCommandExecuted(guid0, new DateTime(2021, 7, 1), new CreatePerson(guid4, null, "Emily", "Coachworthy", Gender.Female, new ExactAge(new DateTime(1980, 3, 19)), "Caucasian", null, null)),
                new FamilyCommandExecuted(guid0, new DateTime(2021, 7, 1), new CreateFamily(guid4, guid4,
                    ...
                    new List<Guid>(), new List<CustodialRelationship>())),
                new PersonCommandExecuted(guid0, new DateTime(2021, 7, 1), new CreatePerson(guid5, null, "Han", "Solo", Gender.Male, new AgeInYears(30, new DateTime(2021, 7, 1)), "Corellian", "Smuggler", null)),
                new PersonCommandExecuted(guid0, new DateTime(2021, 7, 1), new CreatePerson(guid6, null, "Leia", "Skywalker", Gender.Male, new AgeInYears(28, new DateTime(2021, 7, 1)), "Tatooinian", "Freedom fighter", "Uncertain claim to royalty")),
                new PersonCommandExecuted(guid0, new DateTime(2021, 7, 1), new CreatePerson(guid7, null, "Ben", "Solo", Gender.Male, new AgeInYears(12, new DateTime(2021, 7, 1)), "Chandrilan", null, null)),
                new PersonCommandExecuted(guid0, new DateTime(2021, 7, 1), new CreatePerson(guid0, null, "Luke", "Skywalker", Gender.Male, new AgeInYears(28, new DateTime(2021, 7, 1)), "Tatooinian", null, null)),
                new FamilyCommandExecuted(guid0, new DateTime(2021, 7, 1), new CreateFamily(guid2, guid6,
                    new List<(Guid, FamilyAdultRelationshipInfo)>
                    {
                        ...
                        (guid0, new FamilyAdultRelationshipInfo("Sibling", false))
                ...
                new PersonCommandExecuted(guid0, new DateTime(2021, 7, 1), new CreatePerson(guid8, null, "William", "Riker", Gender.Male, new ExactAge(new DateTime(1972, 1, 1)), "Alaskan", null, null)),
                new PersonCommandExecuted(guid0, new DateTime(2021, 7, 1), new CreatePerson(guid9, null, "Deanna", "Riker", Gender.Female, new ExactAge(new DateTime(1970, 1, 1)), "Betazoid", null, null)),
        ...
        public static async Task PopulatePolicies(IObjectStore<EffectiveLocationPolicy> policiesStore)
        {
            await policiesStore.UpsertAsync(guid1, guid2, "policy", new EffectiveLocationPolicy(
                ActionDefinitions: new Dictionary<string, ActionRequirement>
                {
                    ...
                    ["Intake Form"] = new ActionRequirement(DocumentLinkRequirement.Allowed,
                        "Email or text the Cognito Form link", new Uri("http://example.com/forms/intake-v1")),
                    ["Hosting Consent"] = new ActionRequirement(DocumentLinkRequirement.Allowed,
                        "This must be notarized.", new Uri("http://example.com/forms/consent-v1")),
                    ["Medical POA"] = new ActionRequirement(DocumentLinkRequirement.Allowed,
                    ...
                    ["Family Coach Supervision"] = new ActionRequirement(DocumentLinkRequirement.None, null, null),
                    ["Return of Child Form"] = new ActionRequirement(DocumentLinkRequirement.Allowed,
                        null, new Uri("http://example.com/forms/returnofchild-v1")),
                    ["Advocacy Agreement"] = new ActionRequirement(DocumentLinkRequirement.Allowed,
                    ...
                    ["Family Coach Supervision"] = new ActionRequirement(DocumentLinkRequirement.None, null, null),
                    ["Family Friend Application"] = new ActionRequirement(DocumentLinkRequirement.Allowed,
                        null, new Uri("http://example.com/forms/app-ff")),
                    ["Background Check"] = new ActionRequirement(DocumentLinkRequirement.Allowed,
                        "See approval guide for directions", new Uri("http://example.com/forms/bgcheck")),
                    ["Family Coach Application"] = new ActionRequirement(DocumentLinkRequirement.Allowed,
                        null, new Uri("http://example.com/forms/app-fc")),
                    ["Comprehensive Background Check"] = new ActionRequirement(DocumentLinkRequirement.Allowed,
                        "This is an all-in-one background check", new Uri("http://example.com/forms/compbgcheck")),
                    ["Interview with Family Coach Supervisor"] = new ActionRequirement(DocumentLinkRequirement.None, null, null),
                    ["Host Family Application"] = new ActionRequirement(DocumentLinkRequirement.Allowed,
                        null, new Uri("http://example.com/forms/app-hf")),
                    ["Home Screening Checklist"] = new ActionRequirement(DocumentLinkRequirement.Allowed,
                        "Must be filled out by an approved home screener", new Uri("http://example.com/forms/hscheck")),
                    ["Host Family Interview"] = new ActionRequirement(DocumentLinkRequirement.None, null, null)
