    ...
    public static class TestDataProvider
    {
        ...
        public static async Task PopulateReferralEvents(IMultitenantEventLog<ReferralEvent> referralsEventLog)
        {
            await referralsEventLog.AppendEventsAsync(guid1, guid2,
                ...
                new ReferralCommandExecuted(adminId, new DateTime(2020, 3, 5, 4, 15, 15), new CompleteReferralRequirement(guid1, guid1, guid1, "Request for Help Form", new DateTime(2020, 3, 5, 4, 12, 15), guid1)),
                new ReferralCommandExecuted(adminId, new DateTime(2020, 3, 6, 8, 45, 30), new CompleteReferralRequirement(guid1, guid1, guid2, "Intake Coordinator Screening Call", new DateTime(2020, 3, 6, 8, 45, 30), adminId)),
                new ArrangementCommandExecuted(adminId, new DateTime(2020, 3, 11, 11, 12, 13), new CreateArrangement(guid1, guid1, guid1, "Hosting", new DateTime(2020, 3, 11), guid3)),
                ...
                new ArrangementCommandExecuted(adminId, new DateTime(2020, 3, 15, 8, 33, 34), new TrackChildLocationChange(guid1, guid1, guid1,
                    new DateTime(2020, 3, 15, 8, 33, 34), guid3, ChildLocationPlan.DaytimeChildCare)),
                new ArrangementCommandExecuted(adminId, new DateTime(2020, 3, 15, 20, 40, 45), new TrackChildLocationChange(guid1, guid1, guid1,
                        new DateTime(2020, 3, 15, 20, 40, 45), guid2, ChildLocationPlan.DaytimeChildCare)),
                new ArrangementCommandExecuted(adminId, new DateTime(2020, 3, 14, 10, 10, 10), new CompleteArrangementRequirement(guid1, guid1, guid1, guid1,
                    "Family Coach Safety Visit", new DateTime(2020, 3, 14, 10, 10, 10), guid4)),
                new ArrangementCommandExecuted(adminId, new DateTime(2020, 3, 21, 11, 11, 11), new CompleteArrangementRequirement(guid1, guid1, guid1, guid2,
                ...
                new ArrangementCommandExecuted(adminId, new DateTime(2020, 3, 22, 16, 30, 35), new TrackChildLocationChange(guid1, guid1, guid1,
                    new DateTime(2020, 3, 22, 16, 30, 35), guid1, ChildLocationPlan.OvernightHousing)),
        ...
        public static async Task PopulateApprovalEvents(IMultitenantEventLog<ApprovalEvent> approvalsEventLog)
        {
            await approvalsEventLog.AppendEventsAsync(guid1, guid2,
                ...
                new VolunteerCommandExecuted(adminId, new DateTime(2021, 7, 10),
                    new CompleteVolunteerRequirement(guid4, guid4, guid2, "Interview with Family Coach Supervisor", new DateTime(2021, 7, 9), Guid.Empty)),
                ...
                new VolunteerCommandExecuted(adminId, new DateTime(2021, 7, 14),
                    new CompleteVolunteerRequirement(guid4, guid4, guid3, "Background Check", new DateTime(2021, 7, 13), guid2)),
                new VolunteerFamilyCommandExecuted(adminId, new DateTime(2021, 7, 1),
                    new UploadVolunteerFamilyDocument(guid3, guid3, "hfapp.pdf")), 
                new VolunteerFamilyCommandExecuted(adminId, new DateTime(2021, 7, 1),
                    new CompleteVolunteerFamilyRequirement(guid3, guid1, "Host Family Application", new DateTime(2021, 7, 1), guid3)),
                new VolunteerFamilyCommandExecuted(adminId, new DateTime(2021, 7, 15),
                    new CompleteVolunteerFamilyRequirement(guid3, guid2, "Home Screening Checklist", new DateTime(2021, 7, 14), Guid.Empty)),
                ...
                new VolunteerCommandExecuted(adminId, new DateTime(2021, 7, 18),
                    new CompleteVolunteerRequirement(guid3, guid8, guid4, "Background Check", new DateTime(2021, 7, 16), guid4)),
                new VolunteerFamilyCommandExecuted(adminId, new DateTime(2021, 7, 18),
                    new UploadVolunteerFamilyDocument(guid3, guid5, "background check.pdf")),
                new VolunteerCommandExecuted(adminId, new DateTime(2021, 7, 18),
                    new CompleteVolunteerRequirement(guid3, guid9, guid5, "Background Check", new DateTime(2021, 7, 16), guid5)),
                ...
                new VolunteerCommandExecuted(adminId, new DateTime(2021, 8, 10),
                    new CompleteVolunteerRequirement(guid2, guid6, guid6, "Family Friend Application", new DateTime(2021, 8, 10), guid6)),
        ...
        public static async Task PopulateNoteEvents(IMultitenantEventLog<NotesEvent> referralsEventLog)
        {
            await referralsEventLog.AppendEventsAsync(guid1, guid2,
                ...
                new NoteCommandExecuted(guid4, new DateTime(2020, 3, 22, 16, 30, 35), new CreateDraftNote(guid1, guid6, null)),
                ...
                new NoteCommandExecuted(guid4, new DateTime(2020, 3, 30, 18, 18, 18), new CreateDraftNote(guid1, guid8, null)),
