...
namespace CareTogether.TestData
{
    public static class TestDataProvider
    {
        ...
        static DateTime DateOf(int monthOffset, int day) =>
            new DateTime(YEAR, MONTH, day).AddMonths(monthOffset);

        static DateTime DateOf(int monthOffset, int day, int hour, int minute, int second) =>
            new DateTime(YEAR, MONTH, day, hour, minute, second, DateTimeKind.Utc).AddMonths(
                monthOffset
            );
        ...
        static DateTime SetupMonth(int day, int hour, int minute, int second) =>
            DateOf(-3, day, hour, minute, second);
        ...
        static readonly Guid fisherFamilyArrangement1Guid = Guid.Parse(
            "a108cc01-c899-49ea-9e7a-36eefc90e4f1"
        );

        // Brambleswift family
        static readonly Guid berrinBrambleswiftGuid = Guid.Parse(
            "11768904-7738-430a-81b8-fbd7b4168f11"
        );
        static readonly Guid eldaBrambleswiftVolunteerGuid = Guid.Parse(
            "3d49cfb8-af1e-429b-82dc-484559782118"
        );
        static readonly Guid brambleswiftFamilyGuid = Guid.Parse(
            "3ec519ec-a262-4047-b8ef-5ad8c00a2495"
        );
        ...
        public static async Task PopulateAccountEvents(IEventLog<AccountEvent> accountsEventLog)
        {
            ...
            var existingGlobalEvents = await accountsEventLog
                .GetAllEventsAsync(guid0, guid0)
                .ToListAsync();
        ...
        public static async Task PopulatePersonAccessEvents(
            IEventLog<PersonAccessEvent> personAccessEventLog
        )
        {
            await personAccessEventLog.AppendEventsAsync(
                ...
                new PersonAccessEvent(
                    ...
                    new ChangePersonRoles(
                        PersonId: guid0,
                        Roles: [SystemConstants.ORGANIZATION_ADMINISTRATOR]
                    )
                ),
                new PersonAccessEvent(
                    SystemConstants.SystemUserId,
        ...
        public static async Task PopulateDirectoryEvents(
            IEventLog<DirectoryEvent> directoryEventLog
        )
        {
            await directoryEventLog.AppendEventsAsync(
                ...
                new PersonCommandExecuted(
                    adminId,
                    ApprovalsMonth(1),
                    new UpdatePersonAge(guid1, YearsOld(45))
                ),
                new PersonCommandExecuted(
                    adminId,
                    ApprovalsMonth(1),
                    new UpdatePersonAge(guid2, YearsOld(41))
                ),
                new FamilyCommandExecuted(
                    adminId,
                    ApprovalsMonth(1),
            ...
            await referralsEventLog.AppendEventsAsync(
                ...
                new ReferralCommandExecuted(
                    ...
                    new UpdateReferralComments(
                        guid1,
                        guid1,
                        "John and Jane seem eerily... generic."
                    )
                ),
        ...
        public static async Task PopulateGoalEvents(
            IEventLog<GoalCommandExecutedEvent> goalsEventLog
        )
        {
        ...
        public static async Task PopulateApprovalEvents(IEventLog<ApprovalEvent> approvalsEventLog)
        {
            await approvalsEventLog.AppendEventsAsync(
                ...
                new VolunteerFamilyCommandExecuted(
                    adminId,
                    ApprovalsMonth(5),
                    new UploadVolunteerFamilyDocument(
                        brambleswiftFamilyGuid,
                        guid6,
                        "volunteer_family_application.pdf"
                    )
                ),
                new VolunteerFamilyCommandExecuted(
                    adminId,
        ...
        public static async Task PopulateCommunityEvents(
            IEventLog<CommunityCommandExecutedEvent> communitiesEventLog
        )
        {
        ...
        public static async Task PopulatePolicies(
            IObjectStore<EffectiveLocationPolicy> policiesStore
        )
        {
