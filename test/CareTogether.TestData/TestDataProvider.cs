    ...
    public static class TestDataProvider
    {
        ...
        public static async Task PopulateReferralEvents(IEventLog<ReferralEvent> referralsEventLog)
        {
            await referralsEventLog.AppendEventsAsync(guid1, guid2,
                ...
                new ArrangementsCommandExecuted(adminId, new DateTime(2020, 3, 22, 16, 30, 35), new TrackChildLocationChange(guid1, guid1, ImmutableList.Create(guid1),
                    new DateTime(2020, 3, 22, 16, 30, 35), guid1, ChildLocationPlan.OvernightHousing)),
                new ArrangementsCommandExecuted(adminId, new DateTime(2020, 3, 24, 8, 30, 35), new TrackChildLocationChange(guid1, guid1, ImmutableList.Create(guid1),
