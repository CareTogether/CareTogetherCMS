    ...
    public static class TestDataProvider
    {
        ...
        public static async Task PopulateDirectoryEvents(IEventLog<DirectoryEvent> directoryEventLog)
        {
            await directoryEventLog.AppendEventsAsync(guid1, guid2,
                ...
                new FamilyCommandExecuted(adminId, SetupMonth(1), new CreateFamily(guid0, guid0,
                    ...
                    [], [])),
                new PersonCommandExecuted(adminId, ApprovalsMonth(1), new CreatePerson(guid1, "John", "Doe", Gender.Male, YearsOld(40), "Ethnic",
                    [], null, [], null, [], null, null, "DEF")),
                new PersonCommandExecuted(adminId, ApprovalsMonth(1), new CreatePerson(guid2, "Jane", "Smith", Gender.Female, YearsOld(42), "Ethnic",
                    [], null, [], null, [], null, null, null)),
                new PersonCommandExecuted(adminId, ApprovalsMonth(1), new UpdatePersonName(guid2, "Jane", "Doe")),
                new PersonCommandExecuted(adminId, ApprovalsMonth(1), new UpdatePersonAge(guid1, YearsOld(45))),
                new PersonCommandExecuted(adminId, ApprovalsMonth(1), new UpdatePersonAge(guid2, YearsOld(41))),
                new FamilyCommandExecuted(adminId, ApprovalsMonth(1), new CreateFamily(guid1, guid1,
                    [(guid1, new FamilyAdultRelationshipInfo("Dad", true))],
                    [], [])),
                new FamilyCommandExecuted(adminId, ApprovalsMonth(1), new AddAdultToFamily(guid1, guid2, new FamilyAdultRelationshipInfo("Mom", true))),
                new FamilyCommandExecuted(adminId, ApprovalsMonth(5, 4, 15, 15), new UploadFamilyDocument(guid1, guid1, "Jane Doe referral info.pdf")),
                new PersonCommandExecuted(adminId, ApprovalsMonth(1), new CreatePerson(guid3, "Eric", "Doe", Gender.Male, YearsOld(12), "Ethnic",
                    [], null, [], null, [], null, null, null)),
                new FamilyCommandExecuted(adminId, ApprovalsMonth(1), new AddChildToFamily(guid1, guid3,
                [
                ...
                new FamilyCommandExecuted(adminId, ApprovalsMonth(1), new UpdateAdultRelationshipToFamily(guid1, guid1, new FamilyAdultRelationshipInfo("Dad", false))),
                new FamilyCommandExecuted(adminId, ApprovalsMonth(1), new RemoveCustodialRelationship(guid1, guid3, guid1)),
                new FamilyCommandExecuted(adminId, ApprovalsMonth(1), new UpdateCustodialRelationshipType(guid1, guid3, guid2, CustodialRelationshipType.ParentWithCourtAppointedCustody)),
                new FamilyCommandExecuted(adminId, ApprovalsMonth(1), new AddCustodialRelationship(guid1, new CustodialRelationship(guid3, guid1, CustodialRelationshipType.ParentWithCourtAppointedCustody))),
                new PersonCommandExecuted(adminId, ApprovalsMonth(1), new CreatePerson(guid4, "Emily", "Coachworthy", Gender.Female, YearsOld(40), "Caucasian",
                    [], null, [], null, [], null, null, null)),
                new FamilyCommandExecuted(adminId, ApprovalsMonth(1), new CreateFamily(guid4, guid4,
                    [(guid4, new FamilyAdultRelationshipInfo("Single", true))],
                    [], [])),
                new PersonCommandExecuted(adminId, ApprovalsMonth(1), new CreatePerson(guid5, "Han", "Solo", Gender.Male, YearsOld(30), "Corellian",
                    [], null, [], null, [], null, "Smuggler", null)),
                new PersonCommandExecuted(adminId, ApprovalsMonth(1), new CreatePerson(guid6, "Leia", "Skywalker", Gender.Male, YearsOld(28), "Tatooinian",
                    [], null, [], null, [], null, "Freedom fighter", "Uncertain claim to royalty")),
                new PersonCommandExecuted(adminId, ApprovalsMonth(1), new CreatePerson(guid7, "Ben", "Solo", Gender.Male, YearsOld(12), "Chandrilan",
                    [], null, [], null, [], null, null, null)),
                new PersonCommandExecuted(adminId, ApprovalsMonth(1), new CreatePerson(guidA, "Luke", "Skywalker", Gender.Male, YearsOld(28), "Tatooinian",
                    [], null, [], null, [], null, null, null)),
                new FamilyCommandExecuted(adminId, ApprovalsMonth(1), new CreateFamily(guid2, guid6,
                    [
                ...
                new PersonCommandExecuted(adminId, ApprovalsMonth(1), new CreatePerson(guid8, "William", "Riker", Gender.Male, YearsOld(48), "Alaskan",
                    [], null, [], null, [], null, null, null)),
                new PersonCommandExecuted(adminId, ApprovalsMonth(1), new CreatePerson(guid9, "Deanna", "Riker", Gender.Female, YearsOld(50), "Betazoid",
                    [], null, [], null, [], null, null, null)),
                new FamilyCommandExecuted(adminId, ApprovalsMonth(1), new CreateFamily(guid3, guid8,
                    [(guid8, new FamilyAdultRelationshipInfo("Dad", true)), (guid9, new FamilyAdultRelationshipInfo("Mom", true))],
                    [], [])),
                new PersonCommandExecuted(adminId, ApprovalsMonth(1), new AddPersonAddress(guid1,
                    new Address(guid3, "456 Old Ave.", null, "Bigtown", "Down", "TX", "67890"),
                    true)),
                new PersonCommandExecuted(adminId, ApprovalsMonth(1), new AddPersonPhoneNumber(guid1,
                    new PhoneNumber(guid2, "1235554567", PhoneNumberType.Mobile),
                    true)),
                new PersonCommandExecuted(adminId, ApprovalsMonth(1), new AddPersonEmailAddress(guid1,
                ...
                new PersonCommandExecuted(adminId, ApprovalsMonth(1), new AddPersonAddress(guid1,
                    ...
                    true)),
                new PersonCommandExecuted(adminId, ApprovalsMonth(1), new UpdatePersonAddress(guid1,
                    new Address(guid3, "456 Old Ave.", null, "Bigtown", "Down", "TX", "67890"),
                    false)),
                new PersonCommandExecuted(adminId, ApprovalsMonth(1), new AddPersonPhoneNumber(guid1,
                    new PhoneNumber(guid3, "1235555555", PhoneNumberType.Home),
                    true)),
                new PersonCommandExecuted(adminId, ApprovalsMonth(1), new UpdatePersonPhoneNumber(guid1,
                    new PhoneNumber(guid2, "1235554567", PhoneNumberType.Mobile),
                    false)),
                new PersonCommandExecuted(adminId, ApprovalsMonth(1), new AddPersonEmailAddress(guid1,
                    new EmailAddress(guid3, "work@example.com", EmailAddressType.Work),
                    true)),
                new PersonCommandExecuted(adminId, ApprovalsMonth(1), new UpdatePersonEmailAddress(guid1,
                    new EmailAddress(guid2, "personal@example.com", EmailAddressType.Personal),
                    false)),
                //new PersonCommandExecuted(adminId, ApprovalsMonth(1), new UpdatePersonContactMethodPreferenceNotes(guid1,
                //    "Cannot receive voicemails")),
                new PersonCommandExecuted(adminId, ReferralsMonth(1), new AddPersonAddress(guid4,
                    new Address(guid3, "456 Old Ave.", null, "Bigtown", "Down", "TX", "67890"),
                    true)),
                new PersonCommandExecuted(adminId, ReferralsMonth(1), new AddPersonPhoneNumber(guid4,
                    new PhoneNumber(guid2, "1235554567", PhoneNumberType.Mobile),
                    true)),
                new PersonCommandExecuted(adminId, ReferralsMonth(1), new AddPersonEmailAddress(guid4,
                    new EmailAddress(guid2, "personal@example.com", EmailAddressType.Personal),
                    true)),
                new PersonCommandExecuted(adminId, ReferralsMonth(1), new AddPersonAddress(guid4,
                    new Address(guid2, "123 Main St.", "Apt. A", "Smallville", "Jefferson", "NY", "12345"),
                    true)),
                new PersonCommandExecuted(adminId, ReferralsMonth(1), new UpdatePersonAddress(guid4,
                    new Address(guid3, "456 Old Ave.", null, "Bigtown", "Down", "TX", "67890"),
                    false)),
                new PersonCommandExecuted(adminId, ReferralsMonth(1), new AddPersonPhoneNumber(guid4,
                    new PhoneNumber(guid3, "1235555555", PhoneNumberType.Home),
                    true)),
                new PersonCommandExecuted(adminId, ReferralsMonth(1), new UpdatePersonPhoneNumber(guid4,
                    new PhoneNumber(guid2, "1235554567", PhoneNumberType.Mobile),
                    false)),
                new PersonCommandExecuted(adminId, ReferralsMonth(1), new AddPersonEmailAddress(guid4,
                    new EmailAddress(guid3, "work@example.com", EmailAddressType.Work),
                    true)),
                new PersonCommandExecuted(adminId, ReferralsMonth(1), new UpdatePersonEmailAddress(guid4,
                    new EmailAddress(guid2, "personal@example.com", EmailAddressType.Personal),
                    false)),
                //new PersonCommandExecuted(adminId, ReferralsMonth(1), new UpdatePersonContactMethodPreferenceNotes(guid4,
                //    "Cannot receive voicemails"))
                new FamilyCommandExecuted(adminId, StartOfCurrentMonth(), new UploadFamilyDocument(guid1, guid2, "Jane Doe second referral info.pdf")),
                new PersonCommandExecuted(adminId, ReferralsMonth(21), new CreatePerson(guidB, "Emmett", "Brown", Gender.Male, YearsOld(60), "Caucasian",
                    [], null, [], null, [], null, null, null)),
                new PersonCommandExecuted(adminId, ReferralsMonth(21), new CreatePerson(guidC, "Marty", "McFly", Gender.Male, YearsOld(14), "Caucasian",
                    [], null, [], null, [], null, null, null)),
        ...
        public static async Task PopulateReferralEvents(IEventLog<ReferralEvent> referralsEventLog)
        {
            await referralsEventLog.AppendEventsAsync(guid1, guid2,
                new ReferralCommandExecuted(adminId, ReferralsMonth(5, 4, 10, 0), new CreateReferral(guid1, guid1, ReferralsMonth(5, 4, 10, 0))),
                new ReferralCommandExecuted(adminId, ReferralsMonth(5, 4, 15, 15), new CompleteReferralRequirement(guid1, guid1, guid1, "Request for Help Form", ReferralsMonth(5, 4, 12, 15), guid1, null)),
                new ReferralCommandExecuted(adminId, ReferralsMonth(6, 8, 45, 30), new CompleteReferralRequirement(guid1, guid1, guid2, "Intake Coordinator Screening Call", ReferralsMonth(6, 8, 45, 30), adminId, null)),
                new ReferralCommandExecuted(adminId, ReferralsMonth(6, 8, 45, 45), new UpdateReferralComments(guid1, guid1, "John and Jane seem eerily... generic.")),
                new ArrangementsCommandExecuted(adminId, ReferralsMonth(11, 11, 12, 13), new CreateArrangement(guid1, guid1, [guid1], "Hosting", ReferralsMonth(11), guid3, null)),
                new ArrangementsCommandExecuted(adminId, ReferralsMonth(11, 11, 13, 10), new EditArrangementReason(guid1, guid1, [guid1], "Crisis")),
                ...
                new ReferralCommandExecuted(adminId, StartOfCurrentMonth(), new CompleteReferralRequirement(guid1, guid2, guid3, "Request for Help Form", ReferralsMonth(2, 18, 0, 0), guid2, null)),
                new ReferralCommandExecuted(adminId, StartOfCurrentMonth(), new CompleteReferralRequirement(guid1, guid2, guid4, "Intake Coordinator Screening Call",
                    StartOfCurrentMonth(), null, null)),
        ...
        public static async Task PopulateNoteEvents(IEventLog<NotesEvent> referralsEventLog)
        {
            await referralsEventLog.AppendEventsAsync(guid1, guid2,
                ...
                new NoteCommandExecuted(volunteerId, ReferralsMonth(28, 18, 18, 18), new CreateDraftNote(guid1, guid8, null, null)),
                new NoteCommandExecuted(adminId, ReferralsMonth(28, 18, 18, 18), new ApproveNote(guid1, guid8, "Mom met us and picked him up at DQ", null)),
                new NoteCommandExecuted(adminId, ReferralsMonth(28, 10, 0, 0), new CreateDraftNote(guid1, guidA, null, null)),
