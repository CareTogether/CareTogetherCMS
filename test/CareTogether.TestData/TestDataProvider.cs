    ...
    public static class TestDataProvider
    {
            ...
            IMultitenantEventLog<ReferralEvent> referralsEventLog)
        {
            await communityEventLog.AppendEventsAsync(guid1, guid2,
                ...
                new FamilyCommandExecuted(guid0, new DateTime(2021, 7, 1), new UpdateAdultRelationshipToFamily(guid1, guid1, new FamilyAdultRelationshipInfo(FamilyAdultRelationshipType.Dad, "ABC123", false, false, "XYZ"))),
            ...
            await referralsEventLog.AppendEventsAsync(guid1, guid2,
                new ReferralCommandExecuted(guid0, new DateTime(2021, 7, 1), new CreateReferral(guid1, adminId, new DateTime(2020, 3, 5, 4, 10, 0), guid1, "v1")),
                new ReferralCommandExecuted(guid0, new DateTime(2021, 7, 1), new UploadReferralForm(guid1, adminId, new DateTime(2020, 3, 5, 4, 15, 15), "Request for Help Form", "v1", "Jane Doe referral info.pdf")),
                new ReferralCommandExecuted(guid0, new DateTime(2021, 7, 1), new PerformReferralActivity(guid1, adminId, new DateTime(2020, 3, 6, 8, 45, 30), "Intake Coordinator Screening Call")),
                new ArrangementCommandExecuted(guid0, new DateTime(2021, 7, 1), new CreateArrangement(guid1, guid1, adminId, new DateTime(2020, 3, 11, 11, 12, 13), "v1", "Hosting")),
                new ArrangementCommandExecuted(guid0, new DateTime(2021, 7, 1), new AssignIndividualVolunteer(guid1, guid1, adminId, new DateTime(2020, 3, 11, 11, 13, 14), guid4, "Family Coach")),
                new ArrangementCommandExecuted(guid0, new DateTime(2021, 7, 1), new AssignVolunteerFamily(guid1, guid1, adminId, new DateTime(2020, 3, 11, 11, 13, 55), guid2, "Host Family")),
                new ArrangementCommandExecuted(guid0, new DateTime(2021, 7, 1), new AssignVolunteerFamily(guid1, guid1, adminId, new DateTime(2020, 3, 11, 12, 22, 21), guid3, "Host Family Friend")),
                new ArrangementCommandExecuted(guid0, new DateTime(2021, 7, 1), new AssignPartneringFamilyChildren(guid1, guid1, adminId, new DateTime(2020, 3, 11, 11, 14, 32),
                    ImmutableList<Guid>.Empty.Add(guid3))),
                new ArrangementCommandExecuted(guid0, new DateTime(2021, 7, 1), new InitiateArrangement(guid1, guid1, adminId, new DateTime(2020, 3, 12, 16, 55, 0))),
                new ArrangementCommandExecuted(guid0, new DateTime(2021, 7, 1), new TrackChildrenLocationChange(guid1, guid1, adminId, new DateTime(2020, 3, 15, 8, 33, 34),
                    ImmutableList<Guid>.Empty.Add(guid3), guid3, ChildrenLocationPlan.DaytimeChildCare, "Babysitting")),
                new ArrangementCommandExecuted(guid0, new DateTime(2021, 7, 1), new TrackChildrenLocationChange(guid1, guid1, adminId, new DateTime(2020, 3, 15, 20, 40, 45),
                    ImmutableList<Guid>.Empty.Add(guid3), guid2, ChildrenLocationPlan.DaytimeChildCare, "Dropped off with host parents after ☕ and 🍰")),
                new ArrangementCommandExecuted(guid0, new DateTime(2021, 7, 1), new PerformArrangementActivity(guid1, guid1, adminId, new DateTime(2020, 3, 14, 10, 10, 10),
                    guid4, "Family Coach Safety Visit")),
                new ArrangementCommandExecuted(guid0, new DateTime(2021, 7, 1), new PerformArrangementActivity(guid1, guid1, adminId, new DateTime(2020, 3, 21, 11, 11, 11),
                    guid4, "Family Coach Supervision")),
                new ArrangementCommandExecuted(guid0, new DateTime(2021, 7, 1), new TrackChildrenLocationChange(guid1, guid1, adminId, new DateTime(2020, 3, 22, 16, 30, 35),
                ...
                new ArrangementCommandExecuted(guid0, new DateTime(2021, 7, 1), new TrackChildrenLocationChange(guid1, guid1, adminId, new DateTime(2020, 3, 24, 8, 30, 35),
                    ImmutableList<Guid>.Empty.Add(guid3), guid2, ChildrenLocationPlan.OvernightHousing, "Mom dropped off on way to work")),
                new ArrangementCommandExecuted(guid0, new DateTime(2021, 7, 1), new TrackChildrenLocationChange(guid1, guid1, adminId, new DateTime(2020, 3, 30, 18, 18, 18),
                    ImmutableList<Guid>.Empty.Add(guid3), guid1, ChildrenLocationPlan.ReturnToFamily, "Mom met us and picked him up at DQ")),
                new ReferralCommandExecuted(guid0, new DateTime(2021, 7, 1), new CloseReferral(guid1, adminId, new DateTime(2020, 10, 4, 12, 32, 55), ReferralCloseReason.NeedMet)),
                new ReferralCommandExecuted(guid0, new DateTime(2021, 7, 1), new CreateReferral(guid2, adminId, new DateTime(2021, 7, 10, 19, 30, 45), guid1, "v1")),
                new ReferralCommandExecuted(guid0, new DateTime(2021, 7, 1), new UploadReferralForm(guid2, adminId, new DateTime(2021, 7, 10, 19, 32, 0), "Request for Help Form", "v1", "Jane Doe second referral info.pdf")),
                new ReferralCommandExecuted(guid0, new DateTime(2021, 7, 1), new PerformReferralActivity(guid2, adminId, new DateTime(2021, 7, 10, 19, 32, 0), "Intake Coordinator Screening Call")));
        }
