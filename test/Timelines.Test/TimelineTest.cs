...
public class TimelineTest
{
    ...
    private static AbsoluteTimeSpan MMax(int start) => new AbsoluteTimeSpan(D(start), DateTime.MaxValue);

    private static AbsoluteTimeSpan MMaxMax = new AbsoluteTimeSpan(DateTime.MaxValue, DateTime.MaxValue);
    ...
    public void TestTwoContinuousTerminatingStages()
    {
        var dut = new Timeline(
            ImmutableList.Create(new TerminatingTimelineStage(D(1), D(10)), new TerminatingTimelineStage(D(10), D(20)))
        );
    ...
    {
        var dut = new Timeline(
            ImmutableList.Create(new TerminatingTimelineStage(D(1), D(10)), new TerminatingTimelineStage(D(20), D(30)))
        );
    ...
    {
        var dut = new Timeline(ImmutableList<TerminatingTimelineStage>.Empty, new NonTerminatingTimelineStage(D(1)));
