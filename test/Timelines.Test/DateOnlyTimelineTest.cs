...
namespace Timelines.Test
{
    ...
    public class DateOnlyTimelineTest
    {
        ...
        {
            DateOnlyTimeline? dut = new([DR(1, 2), DR(3, 4)]);
        ...
        {
            DateOnlyTimeline? dut1 = new([DR(1, 1)]);
            DateOnlyTimeline? dut2 = new([DR(1, 5)]);
            DateOnlyTimeline? dut3 = new([DR(1, 2), DR(4, 5)]);
        ...
        {
            DateOnlyTimeline? dut1 = new([DR(1, 5)]);
            DateOnlyTimeline? dut2 = new([DR(3, 4), DR(6, 8)]);
        ...
        {
            DateOnlyTimeline? dut = new([DR(1, 5)]);
        ...
        {
            DateOnlyTimeline? dut = new([DR(1, 3), DR(5, 6)]);
        ...
        {
            DateOnlyTimeline? dut = new([DR(1, 3), DR(5, 7)]);
        ...
        {
            DateOnlyTimeline? dut = new([DR(1, 1), DR(3, 4)]);
        ...
        {
            DateOnlyTimeline? dut = new([DR(1, 1), DR(3, 4)]);
            DateOnlyTimeline? other = new([DR(5, 5), DR(7, 8)]);
        ...
        {
            DateOnlyTimeline? dut = new([DR(1, 1), DR(3, 4)]);
            DateOnlyTimeline? other = new([DR(2, 3), DR(4, 5)]);
        ...
        {
            DateOnlyTimeline? input = new([new DateRange(DateOnly.MinValue, DateOnly.MaxValue)]);
        ...
        {
            DateOnlyTimeline? input = new([DR(1, 3)]);
            DateOnlyTimeline? dut = input.Complement();
        ...
        {
            DateOnlyTimeline? input = new([DR(1, 3), DR(5, 5)]);
            DateOnlyTimeline? dut = input.Complement();
        ...
        {
            DateOnlyTimeline? input = new([DR(1, 3), DR(4, 5)]);
            DateOnlyTimeline? dut = input.Complement();
        ...
        {
            DateOnlyTimeline? input = new([new DateRange(DateOnly.MinValue, D(3))]);
            DateOnlyTimeline? dut = input.Complement();
        ...
        {
            DateOnlyTimeline? input = new([new DateRange(D(1), DateOnly.MaxValue)]);
            DateOnlyTimeline? dut = input.Complement();
        ...
        {
            DateOnlyTimeline? input = new([new DateRange(D(1), D(3)), new DateRange(D(4), DateOnly.MaxValue)]);
            DateOnlyTimeline? dut = input.Complement();
        ...
        {
            DateOnlyTimeline? input = new([new DateRange(D(1), D(2)), new DateRange(D(4), DateOnly.MaxValue)]);
            DateOnlyTimeline? dut = input.Complement();
        ...
        {
            DateOnlyTimeline? input = new([new DateRange(DateOnly.MinValue, D(3)), new DateRange(D(5), D(7))]);
            DateOnlyTimeline? dut = input.ForwardOnlyComplement();
        ...
        {
            DateOnlyTimeline? input = new([DR(1, 1), DR(3, 4)]);
        ...
        public void EqualsWithArrayOfDateRangesIsFalse()
        {
            ...
            Assert.IsFalse(dut.Equals(new[] { DR(1, 1), DR(3, 4) }));
        }
        ...
        {
            DateOnlyTimeline? dut = new([DR(1, 1), DR(3, 4)]);
            DateOnlyTimeline? other = new([DR(1, 1), DR(3, 4)]);
        ...
        {
            DateOnlyTimeline? dut = new([DR(1, 1), DR(3, 4)]);
            DateOnlyTimeline? other = new([DR(1, 1), DR(3, 5)]);
        ...
        {
            DateOnlyTimeline? dut = new([DR(1, 1), DR(3, 4)]);
            DateOnlyTimeline? other = new([DR(1, 1)]);
        ...
        {
            DateOnlyTimeline<char>? dut = new([DR(1, 2, 'A'), DR(3, 4, 'B')]);
        ...
        {
            DateOnlyTimeline<char>? dut = new([DR(2, 4, 'A'), DR(6, 6, 'B')]);
        ...
        {
            DateOnlyTimeline<char>? dut = new([DR(1, 1, 'A'), DR(3, 4, 'B')]);
        ...
        public void TaggedEqualsWithArrayOfDateRangesIsFalse()
        {
            ...
            Assert.IsFalse(dut.Equals(new[] { DR(1, 1, 'A'), DR(3, 4, 'B') }));
        }
        ...
        {
            DateOnlyTimeline<char>? dut = new([DR(1, 1, 'A'), DR(3, 4, 'B')]);
            DateOnlyTimeline<char>? other = new([DR(1, 1, 'A'), DR(3, 4, 'B')]);
        ...
        {
            DateOnlyTimeline<char>? dut = new([DR(1, 1, 'A'), DR(3, 4, 'B')]);
            DateOnlyTimeline<char>? other = new([DR(1, 1, 'A'), DR(3, 5, 'B')]);
        ...
        {
            DateOnlyTimeline<char>? dut = new([DR(1, 1, 'A'), DR(3, 4, 'B')]);
            DateOnlyTimeline<char>? other = new([DR(1, 1, 'A')]);
        ...
        {
            DateOnlyTimeline<char>? dut = new([DR(1, 1, 'A'), DR(3, 4, 'B')]);
            DateOnlyTimeline<char>? other = new([DR(1, 1, 'A'), DR(3, 4, 'C')]);
