...
import { Checkbox, FormControl, FormControlLabel, FormGroup, FormLabel, IconButton, Popover } from "@mui/material";
...
export interface IFilterMenuButtonProps {
  ...
  handleFilterChange: (event: ChangeEvent<HTMLInputElement>, checked: boolean) => void;
}

export function FilterMenu({ singularLabel, pluralLabel, filterOptions, handleFilterChange }: IFilterMenuButtonProps) {
  const [filterElement, setFilterElement] = useState<HTMLButtonElement | null>(null);
