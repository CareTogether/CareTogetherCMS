...
import {
  CommunityInfo,
  DeleteUploadedCommunityDocument,
  Permission,
...
export function CommunityDocuments({ communityInfo }: CommunityDocumentsProps) {
  ...
  const deleteCommunityDocument = useCommunityCommand(
    (communityId, documentId: string) => {
