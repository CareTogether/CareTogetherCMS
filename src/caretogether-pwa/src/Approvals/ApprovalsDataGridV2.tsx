...
import {
  approvalLedgerLeafRowIdsForExport,
...
function buildColumns(
  ...
  return [
    ...
    },
    {
      ...
      valueFormatter: (_value, row) => formatApprovalLedgerDate(row.validUntil),
      renderCell: ({ row }) => (
        <Typography {...v2Typography.browserSecondary}>
    ...
    {
      ...reportingLockdown,
      field: APPROVAL_LEDGER_SEARCH_FIELD,
      headerName: 'Search',
...
export function ApprovalsDataGridV2({
  ...
  >(
    () => ({
      ...
      getSortComparator: () => (first, second, firstParams, secondParams) => {
        if (
        ...
        return compareApprovalLedgerMemberKeys(
          memberLabels,
          firstKey,
          secondKey
        );
      ...
      (column): GridColDef<ApprovalLedgerDataGridRowV2> => ({
        ...
        ...(column.field === 'appliesTo' && {
          groupingValueGetter: (_value, row) =>
            approvalLedgerMemberGroupingKey(row),
        }),
        ...
        valueFormatter: column.valueFormatter
          ? (value, row, colDef, apiRef) =>
              formatApprovalLedgerLeafValue(
                ...
                isAutogeneratedRow(row),
                (leafRow) =>
                  column.valueFormatter!(value, leafRow, colDef, apiRef)
              )
          : undefined,
        renderCell: (params) => {
