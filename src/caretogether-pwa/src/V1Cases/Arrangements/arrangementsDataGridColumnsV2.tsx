...
import type { GridColDef, GridComparatorFn } from '@mui/x-data-grid';
import {
  ArrangementPolicy,
  ArrangementPhase,
  ChildInvolvement,
...
function arrangementLocationSummary(row: ArrangementRowV2) {
...
function assignmentSummary(row: ArrangementRowV2) {
...
export function arrangementsDataGridColumns(): GridColDef<ArrangementRowV2>[] {
  return [
    {
    ...
    },
    {
      ...
      valueGetter: (_value, row) =>
        row.functionSummaries
          ...
          .join(' '),
      renderCell: ({ row }) => assignmentSummary(row),
    },
    {
      field: 'openDetails',
      headerName: '',
