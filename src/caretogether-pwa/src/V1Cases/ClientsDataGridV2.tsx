...
export function ClientsDataGridV2({
  ...
  } = usePersistedGridColumnPreferences({
    columns,
  ...
  const visibleColumns = useMemo(
    ...
    [columnVisibilityModel, pivotActive]
  );
      ...
      >
        ...
        <Box sx={{ height: '100%', minHeight: 360 }}>
          <DataGridPremium
            ...
            onColumnVisibilityModelChange={
              pivotActive ? undefined : onColumnVisibilityModelChange
            }
            apiRef={apiRef}
            onColumnOrderChange={pivotActive ? undefined : onColumnOrderChange}
