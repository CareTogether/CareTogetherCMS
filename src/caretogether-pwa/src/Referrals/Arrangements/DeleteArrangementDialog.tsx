...
export function DeleteArrangementDialog({ referralId, arrangement, onClose }: DeleteArrangementDialogProps) {
  ...
  async function save() {
    await referralsModel.deleteArrangement(familyId, referralId, arrangement.id!);
  }

  return (
    <UpdateDialog title={`🛑 Are you sure you want to delete this ${arrangement.arrangementType} arrangement for ${person.firstName} ${person.lastName}?`}
