...
namespace CareTogether.Views
{
    public sealed class CommunityGraph
    {
...
#pragma warning restore IDE1006
        ...
        public CommunityGraph(IGremlinQuerySource gremlinQuerySource)
        {
        ...
        public async Task<ResourceResult<Family>> ExecuteFamilyCommandAsync(Guid organizationId, Guid locationId, FamilyCommand command)
        {
            ...
            var query = command switch
            {
                ...
                UpdateCustodialRelationshipType c => gremlin,
