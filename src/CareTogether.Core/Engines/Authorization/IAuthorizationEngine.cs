...
namespace CareTogether.Engines.Authorization
{
    ...
    public interface IAuthorizationEngine
    {
        ...
        Task<bool> AuthorizeSendSmsAsync(Guid organizationId, Guid locationId, ClaimsPrincipal user);
        ...
        Task<bool> AuthorizeGenerateUserInviteNonceAsync(Guid organizationId, Guid locationId, ClaimsPrincipal user);
