...
namespace CareTogether.Engines.PolicyEvaluation
{
    public static class RequirementRoleAttribution
    {
        ...
        )
        {
            ...
            return familyRoleApprovals.Values.SelectMany(approval => approval.RoleVersionApprovals)
        ...
        )
        {
            ...
            return directIndividualRoleNames
                .Concat(familyAdultRequirementRoleNames)
                .Distinct()
                .ToImmutableList();
        }
    }
