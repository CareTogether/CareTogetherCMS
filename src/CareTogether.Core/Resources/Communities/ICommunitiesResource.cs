...
namespace CareTogether.Resources.Communities
{
    ...
    public sealed record RenameCommunity(Guid CommunityId, string Name) : CommunityCommand(CommunityId);

    public sealed record EditCommunityDescription(Guid CommunityId, string Description) : CommunityCommand(CommunityId);

    public sealed record AddCommunityMemberFamily(Guid CommunityId, Guid FamilyId) : CommunityCommand(CommunityId);

    public sealed record RemoveCommunityMemberFamily(Guid CommunityId, Guid FamilyId) : CommunityCommand(CommunityId);
    ...
    {
        Task<Community> ExecuteCommunityCommandAsync(
            Guid organizationId,
            Guid locationId,
        ...
        Task<Uri> GetCommunityDocumentUploadValetUrl(
            Guid organizationId,
            Guid locationId,
            Guid communityId,
            Guid documentId
