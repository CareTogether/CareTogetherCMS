...
namespace CareTogether.Resources.Communities
{
    ...
    public sealed record AddCommunityRoleAssignment(
        Guid CommunityId,
        Guid PersonId,
        string CommunityRole
    ) : CommunityCommand(CommunityId);

    public sealed record RemoveCommunityRoleAssignment(
        Guid CommunityId,
        Guid PersonId,
        string CommunityRole
    ) : CommunityCommand(CommunityId);

    public sealed record UploadCommunityDocument(
        Guid CommunityId,
    ...
    public interface ICommunitiesResource
    {
        ...
        Task<ImmutableList<Community>> ListLocationCommunitiesAsync(
            Guid organizationId,
            Guid locationId
        );
