...
namespace CareTogether.Resources.Communities
{
    public sealed class CommunitiesResource : ICommunitiesResource
    {
            ...
            Guid communityId, Guid documentId)
        {
            ...
            var valetUrl = await fileStore.GetValetReadUrlAsync(organizationId, locationId, documentSubpath);
            ...
            Guid communityId, Guid documentId)
        {
            ...
            var valetUrl = await fileStore.GetValetCreateUrlAsync(organizationId, locationId, documentSubpath);
