...
namespace CareTogether.Resources.Approvals
{
    ...
    public sealed record UploadVolunteerFamilyDocument(Guid FamilyId, Guid UploadedDocumentId, string UploadedFileName)
        : VolunteerFamilyCommand(FamilyId);
    ...
    public sealed record UnexemptVolunteerRequirement(Guid FamilyId, Guid PersonId, string RequirementName)
        : VolunteerCommand(FamilyId, PersonId);
