...
namespace CareTogether.Resources.Referrals
{
    ...
    public record ArrangementEntry(
        Guid Id,
    ...
    public sealed record ChildLocationHistoryEntry(
        Guid UserId,
    ...
    ) : IComparable<ChildLocationHistoryEntry>
    {
        ...
        {
            return other == null ? 1 : DateTime.Compare(TimestampUtc, other.TimestampUtc);
        }
    }

    public enum ChildLocationPlan
    {
        OvernightHousing,
        DaytimeChildCare,
        WithParent,
    ...
    public sealed record UnexemptReferralRequirement(Guid FamilyId, Guid ReferralId, string RequirementName)
        : ReferralCommand(FamilyId, ReferralId);
    ...
    public sealed record CreateArrangement(
        Guid FamilyId,
        Guid ReferralId,
        ImmutableList<Guid> ArrangementIds,
        string ArrangementType,
    ...
    public sealed record AssignVolunteerFamily(
        Guid FamilyId,
        Guid ReferralId,
        ImmutableList<Guid> ArrangementIds,
        Guid VolunteerFamilyId,
    ...
    public sealed record UnassignVolunteerFamily(
        Guid FamilyId,
        Guid ReferralId,
        ImmutableList<Guid> ArrangementIds,
        Guid VolunteerFamilyId,
    ...
    public sealed record PlanArrangementStart(
        Guid FamilyId,
        Guid ReferralId,
        ImmutableList<Guid> ArrangementIds,
        DateTime? PlannedStartUtc
    ...
    public sealed record StartArrangements(
        Guid FamilyId,
        Guid ReferralId,
        ImmutableList<Guid> ArrangementIds,
        DateTime StartedAtUtc
    ...
    public sealed record EditArrangementStartTime(
        Guid FamilyId,
        Guid ReferralId,
        ImmutableList<Guid> ArrangementIds,
        DateTime StartedAtUtc
    ...
    public sealed record CompleteVolunteerFamilyAssignmentRequirement(
        Guid FamilyId,
        Guid ReferralId,
        ImmutableList<Guid> ArrangementIds,
        string ArrangementFunction,
    ...
    public sealed record CompleteIndividualVolunteerAssignmentRequirement(
        Guid FamilyId,
        Guid ReferralId,
        ImmutableList<Guid> ArrangementIds,
        string ArrangementFunction,
    ...
    public sealed record MarkArrangementRequirementIncomplete(
        Guid FamilyId,
        Guid ReferralId,
        ImmutableList<Guid> ArrangementIds,
        Guid CompletedRequirementId,
    ...
    public sealed record MarkVolunteerFamilyAssignmentRequirementIncomplete(
        Guid FamilyId,
        Guid ReferralId,
        ImmutableList<Guid> ArrangementIds,
        string ArrangementFunction,
    ...
    public sealed record MarkIndividualVolunteerAssignmentRequirementIncomplete(
        Guid FamilyId,
        Guid ReferralId,
        ImmutableList<Guid> ArrangementIds,
        string ArrangementFunction,
    ...
    public sealed record ExemptArrangementRequirement(
        Guid FamilyId,
        Guid ReferralId,
        ImmutableList<Guid> ArrangementIds,
        string RequirementName,
    ...
    public sealed record ExemptVolunteerFamilyAssignmentRequirement(
        Guid FamilyId,
        Guid ReferralId,
        ImmutableList<Guid> ArrangementIds,
        string ArrangementFunction,
    ...
    public sealed record ExemptIndividualVolunteerAssignmentRequirement(
        Guid FamilyId,
        Guid ReferralId,
        ImmutableList<Guid> ArrangementIds,
        string ArrangementFunction,
    ...
    public sealed record UnexemptArrangementRequirement(
        Guid FamilyId,
        Guid ReferralId,
        ImmutableList<Guid> ArrangementIds,
        string RequirementName,
    ...
    public sealed record UnexemptVolunteerFamilyAssignmentRequirement(
        Guid FamilyId,
        Guid ReferralId,
        ImmutableList<Guid> ArrangementIds,
        string ArrangementFunction,
    ...
    public sealed record UnexemptIndividualVolunteerAssignmentRequirement(
        Guid FamilyId,
        Guid ReferralId,
        ImmutableList<Guid> ArrangementIds,
        string ArrangementFunction,
    ...
    public sealed record PlanChildLocationChange(
        Guid FamilyId,
        Guid ReferralId,
        ImmutableList<Guid> ArrangementIds,
        DateTime PlannedChangeUtc,
        Guid ChildLocationFamilyId,
        Guid ChildLocationReceivingAdultId,
        ChildLocationPlan Plan
    ) : ArrangementsCommand(FamilyId, ReferralId, ArrangementIds);

    public sealed record DeletePlannedChildLocationChange(
        Guid FamilyId,
        Guid ReferralId,
        ImmutableList<Guid> ArrangementIds,
        DateTime PlannedChangeUtc,
    ...
    public sealed record TrackChildLocationChange(
        Guid FamilyId,
        Guid ReferralId,
        ImmutableList<Guid> ArrangementIds,
    ...
    public sealed record DeleteChildLocationChange(
        Guid FamilyId,
        Guid ReferralId,
        ImmutableList<Guid> ArrangementIds,
        DateTime ChangedAtUtc,
    ...
    public sealed record PlanArrangementEnd(
        Guid FamilyId,
        Guid ReferralId,
        ImmutableList<Guid> ArrangementIds,
        DateTime? PlannedEndUtc
    ...
    public sealed record EndArrangements(
        Guid FamilyId,
        Guid ReferralId,
        ImmutableList<Guid> ArrangementIds,
        DateTime EndedAtUtc
    ...
    public sealed record ReopenArrangements(
        Guid FamilyId,
        Guid ReferralId,
        ImmutableList<Guid> ArrangementIds,
        Guid? NoteId
    ...
    public sealed record CancelArrangementsSetup(
        Guid FamilyId,
        Guid ReferralId,
        ImmutableList<Guid> ArrangementIds,
        DateTime CancelledAtUtc
    ...
    public sealed record UpdateArrangementComments(
        Guid FamilyId,
        Guid ReferralId,
        ImmutableList<Guid> ArrangementIds,
        string? Comments
    ...
    public sealed record EditArrangementReason(
        Guid FamilyId,
        Guid ReferralId,
        ImmutableList<Guid> ArrangementIds,
        string? Reason
