    ...
    public sealed class DirectoryResource : IDirectoryResource
    {
        ...
        public DirectoryResource(IEventLog<DirectoryEvent> eventLog, IFileStore fileStore)
        {
            ...
            tenantModels = new ConcurrentLockingStore<
                ...
                DirectoryModel
            >(key =>
                DirectoryModel.InitializeAsync(
        ...
        )
        {
            ...
            {
                var result = lockedModel.Value.ExecuteFamilyCommand(
                    command,
                    userId,
                    DateTime.UtcNow
                );
        ...
        )
        {
            ...
            {
                var result = lockedModel.Value.ExecutePersonCommand(
                    command,
                    userId,
                    DateTime.UtcNow
                );
        ...
        public async Task<ImmutableList<Person>> ListPeopleAsync(
            Guid organizationId,
            Guid locationId
        )
        {
        ...
        public async Task<ImmutableList<Family>> ListFamiliesAsync(
            Guid organizationId,
            Guid locationId
        )
        {
        ...
        public async Task<Family?> FindFamilyAsync(
            Guid organizationId,
            Guid locationId,
            Guid familyId
        )
        ...
        public async Task<Family?> FindPersonFamilyAsync(
            Guid organizationId,
            Guid locationId,
            Guid personId
        )
