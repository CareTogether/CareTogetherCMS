...
namespace CareTogether.Resources.Directory
{
    ...
    public sealed record AddCustodialRelationship(
        Guid FamilyId,
    ...
    public sealed record RemoveCustodialRelationship(
        Guid FamilyId,
        Guid ChildPersonId,
        Guid AdultPersonId
    ) : FamilyCommand(FamilyId);

    public sealed record UploadFamilyDocument(
        Guid FamilyId,
        Guid UploadedDocumentId,
        string UploadedFileName
    ) : FamilyCommand(FamilyId);

    public sealed record DeleteUploadedFamilyDocument(Guid FamilyId, Guid UploadedDocumentId)
        : FamilyCommand(FamilyId);
    ...
    public sealed record AddPersonPhoneNumber(
        Guid PersonId,
        PhoneNumber PhoneNumber,
        bool IsPreferredPhoneNumber
    ) : PersonCommand(PersonId);

    public sealed record UpdatePersonPhoneNumber(
        Guid PersonId,
        PhoneNumber PhoneNumber,
        bool IsPreferredPhoneNumber
    ) : PersonCommand(PersonId);
    ...
    public interface IDirectoryResource
    {
        ...
        Task<Uri> GetFamilyDocumentUploadValetUrl(
            Guid organizationId,
            Guid locationId,
            Guid familyId,
            Guid documentId
