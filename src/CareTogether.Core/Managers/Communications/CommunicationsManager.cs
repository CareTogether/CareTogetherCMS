...
namespace CareTogether.Managers.Communications
{
    public sealed class CommunicationsManager : ICommunicationsManager
    {
        ...
        public async Task<
            ImmutableList<(Guid FamilyId, SmsMessageResult? Result)>
        ...
        )
        {
            ...
            var sourcePhoneNumber = configuration
                ...
                .SmsSourcePhoneNumbers.SingleOrDefault(number =>
                    number.SourcePhoneNumber == sourceNumber
                )
                ?.SourcePhoneNumber;
                ...
                .Select(familyId =>
                {
                    ...
                    var primaryContactAdult = family
                        ...
                        .SingleOrDefault(person =>
                            person.Id == family.PrimaryFamilyContactPersonId
                        );
                    return (
                        familyId,
            ...
            var sendResults = await telephony.SendSmsMessageAsync(
                sourcePhoneNumber,
                destinationNumbers,
                message
            );
            ...
            var allFamilyResults = familyPrimaryContactNumbers
                .Select(x =>
                {
                    var sendResult = sendResults.SingleOrDefault(result =>
